...
skills.forEach((item) => {
    ...
    item.addEventListener('mouseleave', () => {
        if(verificaskillsanimation){
            ...
            var text = document.querySelector('.desc')
            text.innerHTML = 'As habilidades que adquiri enquanto estudava.<strong class="mousehoveraviso">(Passe o mouse em cima ou clique para ver as descrições)</strong>'
